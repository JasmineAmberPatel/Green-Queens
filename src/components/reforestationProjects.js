    ...
    return(
        <div className="reforestation-projects">
                ...
                <h4 className="location">Brazil</h4>
                    ...
                    <a className="Project-link" style={{display: "table-cell"}} href="https://printreleaf.com/projects/brazil" target="_blank">Read more here</a>
                </div>
                <div className="Project">
                    ...
                    <a className="Project-link" style={{display: "table-cell"}} href="https://printreleaf.com/projects/dominican" target="_blank">Read more here</a>
                </div>
                <div className="Project">
                    ...
                    <a className="Project-link" style={{display: "table-cell"}} href="https://printreleaf.com/projects/india" target="_blank">Read more here</a>
                </div>
                <div className="Project">
                    ...
                    <a className="Project-link" style={{display: "table-cell"}} href="https://printreleaf.com/projects/ireland" target="_blank">Read more here</a>
                </div>
                <div className="Project">
                    ...
                    <a className="Project-link" style={{display: "table-cell"}} href="https://printreleaf.com/projects/madagascar" target="_blank">Read more here</a>
                </div>
                <div className="Project">
                    ...
                    <a className="Project-link" style={{display: "table-cell"}} href="https://printreleaf.com/projects/mexico" target="_blank">Read more here</a>
                </div>
                <div className="Project">
                    ...
                    <a className="Project-link" style={{display: "table-cell"}} href="https://printreleaf.com/projects/us" target="_blank">Read more here</a>
                </div>
        </div> 
    )
}
